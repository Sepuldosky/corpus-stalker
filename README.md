...
ecosistema con modelos de la Zona (las dos mochilas, vía la API de sustitución de modelos de
Cargo) y los assets de ítem que ya consumen Cargo y Craving. Las entidades (anomalías,
